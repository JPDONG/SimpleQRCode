...
public class ViewFinderView extends View{
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        ...
        */
        canvas.drawCircle(getWidth() * 1/4,getHeight() * 7/23,1,mBorderPaint);
        canvas.drawLine(getWidth() * 1/4,getHeight() * 7/23,getWidth() * 1/4,getHeight() * 7/23 + 100,mBorderPaint);
        canvas.drawLine(getWidth() * 1/4,getHeight() * 7/23,getWidth() * 1/4 + 100,getHeight() * 7/23,mBorderPaint);

        canvas.drawLine(getWidth() * 3/4,getHeight() * 7/23,getWidth() * 3/4,getHeight() * 7/23 + 100,mBorderPaint);
        canvas.drawLine(getWidth() * 3/4,getHeight() * 7/23,getWidth() * 3/4 - 100,getHeight() * 7/23,mBorderPaint);

        canvas.drawLine(getWidth() * 1/4,getHeight() * 7/23 + getWidth()/2,getWidth() * 1/4,getHeight() * 7/23 + getWidth()/2 - 100,mBorderPaint);
        canvas.drawLine(getWidth() * 1/4,getHeight() * 7/23 + getWidth()/2,getWidth() * 1/4 + 100,getHeight() * 7/23 + getWidth()/2,mBorderPaint);

        canvas.drawLine(getWidth() * 3/4,getHeight() * 7/23 + getWidth()/2,getWidth() * 3/4,getHeight() * 7/23 + getWidth()/2 - 100,mBorderPaint);
        canvas.drawLine(getWidth() * 3/4,getHeight() * 7/23 + getWidth()/2,getWidth() * 3/4 - 100,getHeight() * 7/23 + getWidth()/2,mBorderPaint);
